  ...
  return (
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className={cn(
          "src:bg-background src:dark:data-[state=unchecked]:bg-foreground src:dark:data-[state=checked]:bg-duck-navy src:pointer-events-none src:block src:rounded-full src:ring-0 src:transition-transform src:group-data-[size=default]/switch:size-4 src:group-data-[size=sm]/switch:size-3 src:data-[state=unchecked]:translate-x-0 src:data-[state=checked]:translate-x-[calc(100%-2px)]",
        )}
      />
    </SwitchPrimitive.Root>
  )
