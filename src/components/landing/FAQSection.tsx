...
import { ChevronDown, Car, MessageCircle } from "lucide-react"
    ...
    <section id="faq" className="bg-off-white py-20 px-4 md:px-10">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mt-12 flex flex-col items-stretch sm:items-center gap-4">
          ...
          <div className="w-full rounded-2xl border border-amber-200 bg-amber-50 p-5 sm:p-6 flex flex-col sm:flex-row items-start sm:items-center gap-4">
            <div className="flex items-center justify-center size-11 shrink-0 rounded-full bg-amber-100 text-amber-700">
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 w-full sm:w-auto shrink-0 rounded-full bg-[#25D366] text-white font-medium text-sm px-5 py-2.5 hover:bg-[#20bd5a] transition-colors"
            >
