...
export default function ActivityFilters({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "mx-auto w-fit flex items-center gap-2 rounded-full px-2 py-2 shadow-lg",
        isDark
      ...
      {ACTIVITY_FILTERS.map((filter) => {
        ...
        return (
          <button
            ...
            className={cn(
              "flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium transition-all duration-200 cursor-pointer whitespace-nowrap",
              isActive
