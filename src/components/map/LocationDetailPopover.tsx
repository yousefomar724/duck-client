...
export default function LocationDetailPopover({
    ...
    <>
      ...
      <div className="flex flex-col min-h-0 flex-1">
        <div className="px-4 pt-2 pb-4 flex flex-col gap-3">
          ...
          <div className="max-h-24 sm:max-h-16 break-all overflow-y-auto overscroll-contain scrollbar-duck rounded-lg">
  ...
  return isMobile ? (
    <Sheet open={open} onOpenChange={handleOpenChange}>
      <SheetContent
        side="bottom"
        className="bg-duck-navy-deep! text-white border-none p-0! overflow-hidden rounded-t-2xl max-h-[90vh] flex flex-col z-[100] text-start"
        dir={locale === "ar" ? "rtl" : "ltr"}
      >
        <div className="overflow-y-auto max-h-[90vh] pb-[env(safe-area-inset-bottom)]">
          {content}
        </div>
      </SheetContent>
    </Sheet>
    ...
    <Popover open={open} onOpenChange={handleOpenChange}>
      ...
      <PopoverContent
        ...
        dir={locale === "ar" ? "rtl" : "ltr"}
        className={cn(
          "bg-duck-navy-deep! text-white border-none p-0! overflow-hidden rounded-xl shadow-2xl z-[100] flex flex-col text-start",
